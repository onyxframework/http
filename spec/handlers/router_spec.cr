require "../spec_helper"
require "../../src/atom/handlers/router"

describe Atom::Handlers::Router do
  ...
  context "get /users/42" do
    ...
    it "updates context proc" do
      context.proc.should be_a(::Proc(HTTP::Server::Context, Nil))
    end
  ...
  context "ws /foo/baz" do
    ...
    it "updates context proc" do
      context.proc.should be_a(HTTP::WebSocketHandler)
    end
  ...
  context "get /unknown" do
    ...
    it "doesn't update context proc" do
      context.proc.should be_nil
    end
